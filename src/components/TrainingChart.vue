<template>
  ...
  <v-app id="trainingchart">
    <v-card>
    <v-container>
       <vueapexchart ref="chart" type="line" height="350" :options="chartOptions" :series="series"></vueapexchart>
       <v-btn @click="updateChart()">Load Data</v-btn>
    </v-container>
    </v-card>
  </v-app>
</template>
